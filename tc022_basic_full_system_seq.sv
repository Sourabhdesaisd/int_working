class tc022_basic_full_system_seq extends uvm_sequence #(int_seq_item);
  ...
  task body();
    ...
    //------------------------------------------------------------
    // Transaction-3 : MMR Write IRQ0 Priority = FF
    //------------------------------------------------------------
    ...
    //------------------------------------------------------------
    // Transaction-4 : Read IRQ0 Priority Register
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("read_irq0_priority");
    ...
    //------------------------------------------------------------
    // Transaction-7 : Wait One Transaction
    //------------------------------------------------------------
...
finish_item(tr);
    ...
    //------------------------------------------------------------
    // Transaction-10 : Send EOI for IRQ0
    //------------------------------------------------------------
    ...
    tr.soc_eoi_id_i    = 8'h10;   // ACK ID for IRQ0
...
finish_item(tr);
    ...
    //------------------------------------------------------------
    // Transaction-13 : Read ACK Register
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("read_ack_register");
    ...
    tr.soc_mmr_read_en_i    = 1'b1;
    tr.soc_mmr_read_addr_i  = 16'h0000;    // ACK MMR Address (replace with actual ACK register address if different)
    ...
    //------------------------------------------------------------
    // Transaction-14 : Disable Global Interrupt Enable
    //------------------------------------------------------------
