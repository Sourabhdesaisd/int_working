...
output  reg [15:0]     interrupt_pending_o       ,  // to memoey mapped register
...
begin
    ...
    begin
	  ...
	  begin
      interrupt_pending_o <= {int15_p,int14_p,int13_p,int12_p,int11_p,int10_p,int9_p,int8_p,int7_p,int6_p,int5_p,int4_p,int3_p,int2_p,int1_p,int0_p};
