...
//input 		        soc_rst				                ,
//input             wdt_reset_i                   ,
input [7:0]       highest_pending_lvl_pr_i	    , //from soc_pr block
...
output[7:0]	      interrupt_id_o		    	      , //to soc_ack_mmr
output	   	      interrupt_id_valid_o	        , //to soc_ack_mmr
//input		          soc_eoi_valid			            , //end of interrupt signal from core
...
//wire pending_irq_valid; no load
/*
...
//assign interrupt_request_o = (sufficient_level_valid | (soc_eoi_valid && interrupt_pending_w ))? 1'b1 	   : 1'b0;
//assign interrupt_id_o	     = (sufficient_level_valid | (soc_eoi_valid && interrupt_pending_w ))? highest_pending_int_id_i: 8'd0;
//assign interrupt_id_valid_o= (sufficient_level_valid | (soc_eoi_valid && interrupt_pending_w ))? 1'b1 	   : 1'b0;
