`timescale 1ns / 1ps
//soc memory mapped register control
//ctl ie ip attr
...
input [15:0] 	soc_int_pending_bit	,
input           soc_int_pending_valid	,
input [15:0]	global_int_enable_bit	,
...
.soc_mmr_write_addr		(soc_mmr_write_addr		),
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[0]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[0]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq0_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[1]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[1]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq1_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[2]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[2]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq2_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[3]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[3]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq3_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[4]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid	),
.global_int_enable_bit		(global_int_enable_bit[4]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq4_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[5]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[5]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq5_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[6]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[6]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq6_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[7]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[7]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq7_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[8]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[8]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq8_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[9]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[9]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq9_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[10]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[10]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq10_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[11]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[11]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq11_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[12]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[12]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq12_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[13]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[13]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq13_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[14]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[14]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq14_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[15]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[15]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq15_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[16]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[16]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq16_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[17]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[17]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq17_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[18]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[18]	),
.global_int_enable_valid 	(global_int_enable_valid	),
	.soc_irq_ctrl_o			(irq18_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[19]	),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[19]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq19_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[20]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[20]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq20_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[21]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[21]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq21_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[22]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[22]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq22_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[23]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[23]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq23_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[24]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[24]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq24_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[25]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[25]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq25_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[26]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[26]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq26_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[27]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[27]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq27_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[28]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[28]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq28_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[29]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[29]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq29_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[30]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[30]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq30_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[31]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[31]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq31_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[32]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[32]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq32_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[33]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[33]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq33_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[34]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[34]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq34_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[35]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[35]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq35_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[36]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[36]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq36_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[37]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[37]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq37_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[38]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[38]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq38_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[39]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[39]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq39_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[40]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[40]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq40_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[41]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[41]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq41_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[42]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[42]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq42_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[43]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[43]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq43_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[44]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[44]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq44_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[45]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[45]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq45_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[46]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[46]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq46_ctrl_o			)
...
.soc_mmr_write_en		(soc_mmr_write_en		),
.soc_mmr_write_data		(soc_mmr_write_data		),
.soc_int_pending_bit		(soc_int_pending_bit[47]		),
.soc_int_pending_bit_valid 	(soc_int_pending_valid		),
.global_int_enable_bit		(global_int_enable_bit[47]	),
.global_int_enable_valid 	(global_int_enable_valid	),
.soc_irq_ctrl_o			(irq47_ctrl_o			)
...
module irq_ctrl #(parameter MMR_CTL_ADDR  = 16'h0,
		  parameter MMR_ATTR_ADDR = 16'h0,
	          parameter MMR_IE_ADDR   = 16'h0,
	          parameter MMR_IP_ADDR  = 16'h0,
		  parameter LVL_PR_VAL	= 8'h0 
	  	)
(
input 		soc_clk				,
input 		soc_rst				,
...
input 		soc_mmr_write_en		,
input [31:0] 	soc_mmr_write_data		,
input 		soc_int_pending_bit		,
input 		soc_int_pending_bit_valid 	,
input 		global_int_enable_bit		,
input 		global_int_enable_valid 	,
output	[31:0]  soc_irq_ctrl_o			

);

reg [7:0] soc_ie_mmr;
reg [7:0] soc_ip_mmr;
reg [7:0] soc_attr_mmr;
reg [7:0] soc_ctl_mmr;


always@(posedge soc_clk or negedge soc_rst) //ie
begin
	if(!soc_rst)
	begin
		soc_ie_mmr <= 8'd0;
	...
	begin
		if(soc_mmr_write_en && (soc_mmr_write_addr ==MMR_IE_ADDR))
		begin
			soc_ie_mmr <= {7'd0,soc_mmr_write_data[0]};
		end
		else if(global_int_enable_valid)
		begin
			soc_ie_mmr <= {7'd0,global_int_enable_bit};
		end
	end
end

always@(posedge soc_clk or negedge soc_rst) //ip
begin
		if(!soc_rst)
	begin
		soc_ip_mmr <= 8'd0;
	...
	begin
		if(soc_mmr_write_en && (soc_mmr_write_addr ==MMR_IP_ADDR))
		begin
			soc_ip_mmr <= {7'd0,soc_mmr_write_data[0]};
		end
		else if(soc_int_pending_bit_valid)
		begin
			soc_ip_mmr <= {7'd0,soc_int_pending_bit};
		end
	end

end

always@(posedge soc_clk or negedge soc_rst) //attr
begin
	if(!soc_rst)
	begin
		soc_attr_mmr <= 8'd0;
	...
	begin
		soc_attr_mmr <= {2'b11,6'd0};
	end
end

always@(posedge soc_clk or negedge soc_rst) //ctl
begin
	if(!soc_rst)
	begin
		soc_ctl_mmr <= LVL_PR_VAL;
	end
        else if(wdt_reset_i)
    begin
        soc_ctl_mmr <= 8'd0;
	...
	begin
		if(soc_mmr_write_en && (soc_mmr_write_addr == MMR_CTL_ADDR))
		begin
			soc_ctl_mmr <= soc_mmr_write_data[7:0];
		end
	end
...
assign soc_irq_ctrl_o = {soc_ctl_mmr,soc_attr_mmr,soc_ie_mmr,soc_ip_mmr};
endmodule
