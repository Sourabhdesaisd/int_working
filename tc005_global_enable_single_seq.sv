class tc005_global_enable_single_seq extends uvm_sequence #(int_seq_item);

  `uvm_object_utils(tc005_global_enable_single_seq)

  int_seq_item tr;

  function new(string name="tc005_global_enable_single_seq");
    super.new(name);
  endfunction
  ...
  task body();
    ...
    //------------------------------------------------------------
    // Transaction-5 : Enable IRQ7
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("enable_irq7");
    start_item(tr);
    ...
    tr.global_int_enable_valid_i = 1'b1;
    tr.global_int_enable_bit_i   = 16'h0080;
    ...
    //------------------------------------------------------------
    // Transaction-6 : Disable IRQ7
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("disable_irq7");
    start_item(tr);
    ...
    //------------------------------------------------------------
    // Transaction-7 : Enable IRQ15
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("enable_irq15");
    start_item(tr);
    ...
    tr.global_int_enable_valid_i = 1'b1;
    tr.global_int_enable_bit_i   = 16'h8000;
    ...
    //------------------------------------------------------------
    // Transaction-8 : Disable IRQ15
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("disable_irq15");
    start_item(tr);
