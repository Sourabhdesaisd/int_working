class tc002_mmr_multiple_rw_seq extends uvm_sequence #(int_seq_item);

  `uvm_object_utils(tc002_mmr_multiple_rw_seq)

  int_seq_item tr;

  function new(string name = "tc002_mmr_multiple_rw_seq");
    super.new(name);
  endfunction
  ...
  task body();
    ...
    // Write IRQ1
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("write_irq1");
    start_item(tr);
    ...
    tr.soc_mmr_write_data_i = 32'h87654321;
    ...
    // Write IRQ2
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("write_irq2");
    start_item(tr);
    ...
    tr.soc_mmr_write_data_i = 32'hA5A55A5A;
    ...
    // Write IRQ3
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("write_irq3");
    start_item(tr);
    ...
    tr.soc_mmr_write_data_i = 32'h5A5AA5A5;
    ...
    // Read IRQ1
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("read_irq1");
    start_item(tr);
    ...
    tr.soc_mmr_read_en_i   = 1'b1;
    tr.soc_mmr_read_addr_i = 16'h1007;
    ...
    // Read IRQ2
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("read_irq2");
    start_item(tr);
    ...
    tr.soc_mmr_read_en_i   = 1'b1;
    tr.soc_mmr_read_addr_i = 16'h100B;
    ...
    // Read IRQ3
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("read_irq3");
    start_item(tr);
    ...
    tr.soc_mmr_read_en_i   = 1'b1;
    tr.soc_mmr_read_addr_i = 16'h100F;
