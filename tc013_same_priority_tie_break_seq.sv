class tc013_same_priority_tie_break_seq extends uvm_sequence #(int_seq_item);

  `uvm_object_utils(tc013_same_priority_tie_break_seq)

  int_seq_item tr;

  function new(string name="tc013_same_priority_tie_break_seq");
    super.new(name);
  endfunction
  ...
  task body();
    ...
    //------------------------------------------------------------
    // Transaction-3 : Program IRQ2 Priority = 0xA0
    //------------------------------------------------------------
    ...
    //------------------------------------------------------------
    // Transaction-4 : Program IRQ5 Priority = 0xA0
    //------------------------------------------------------------
    ...
    //------------------------------------------------------------
    // Transaction-5 : Program IRQ9 Priority = 0xA0
    //------------------------------------------------------------
    ...
    //------------------------------------------------------------
    // Transaction-7 : Assert IRQ2, IRQ5 and IRQ9 Together
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("assert_same_priority_irqs");
    ...
    finish_item(tr);
        ...
        //------------------------------------------------------------
    // Transaction-8 : Wait for Arbitration
    //------------------------------------------------------------
    tr = int_seq_item::type_id::create("wait_priority_resolution");
    ...
    //------------------------------------------------------------
    // Transaction-11 : Keep IRQs Asserted
    //------------------------------------------------------------
    ...
    //------------------------------------------------------------
    // Transaction-12 : Clear All Interrupts
    //------------------------------------------------------------
    ...
    //------------------------------------------------------------
    // Transaction-13 : Wait After Clear
    //------------------------------------------------------------
    ...
    //------------------------------------------------------------
    // Transaction-14 : Disable All Interrupts
    //------------------------------------------------------------
